...
ggplot(millas, aes(clase, traccion)) +
  geom_point()
# No es útil este gráfico para representar la relacion entre "clase" y "traccion" ya que los
# valores que estas variables asumen no son optimos como para representarlos en un grafico
# de dispersión
```
...
```{r}
# Hay varios autos que hacen menos de 20,3 millas por galón en autopista, se puede observar
# que la mayoria de ellos tienen una cilindrada menor a 3.
...
# introduce un poco de ruido a los puntos de cada categoría y nos permite ver la densidad de
# puntos en cada categoría ya que se superponen menos que sin jitter
```
